        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.orders.index') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                        &larr; Back
                    </a>
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Order #{{ $this->order->order_number }}</h2>
                            ...
                            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                <div class="py-4 flex items-center justify-between">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 class="font-medium text-gray-900 dark:text-white">{{ $item->variant->product->name }}</h4>
                                            <p class="text-sm text-gray-500">{{ $item->variant->unit_size }} x {{ $item->quantity }}</p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-bold text-gray-900 dark:text-white">₹{{ number_format($item->price * $item->quantity) }}</p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg border border-gray-100 dark:border-gray-700 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select wire:model="status" wire:change="updateStatus" class="w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            ...
                            <div>
                                ...
                                <select wire:model="paymentStatus" wire:change="updatePaymentStatus" class="w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg border border-gray-100 dark:border-gray-700 p-6">
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 dark:text-white">{{ $order->user->name ?? 'Guest User' }}</p>
